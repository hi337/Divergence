...
gb_classifier = GradientBoostingClassifier(n_estimators=100, random_state=42)  # You can adjust the number of trees
...
joblib.dump(gb_classifier, 'gradient_boosting_model_r_value.joblib')
